document.addEventListener('DOMContentLoaded', function () { // esta funcion es para mostrar el botón de "Iniciar Sesión" y el botón de "Carrito" dependiendo de si el usuario ha iniciado sesión o no
    ...
    if (logueado) {
        document.getElementById('loginButton').style.display = 'none'; // Si el usuario  ha iniciado sesión, no mostrara el botón de "Iniciar Sesión"
        ...
        document.getElementById('loginButton').style.display = 'inline-block';// Si el usuario no ha iniciado sesión, mostrara el botón de "Iniciar Sesión"
...
document.getElementById('logoutButton').addEventListener('click', function () { // esta funcion es para cerrar la sesión del usuario
    localStorage.removeItem('logueado'); // se elimina la sesion del usuario en el local storage
